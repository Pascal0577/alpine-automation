...
copy_scripts() {
    ...
    cp ../rebuild-grub "$dir/sbin/"                        || log_error "In copy_scripts: Failed to copy rebuild-grub"
    cp ../bootloader-rebuild "$dir/etc/init.d/"            || log_error "In copy_scripts: Failed to copy bootloader-rebuild"
    ...
    cp ../mkinitfs-hook.sh "$dir/etc/apk/commit_hooks.d/"  || log_error "In copy_scripts: Failed to copy mkinitfs-hooke.sh"
    cp ../kernel-hook.sh "$dir/etc/apk/commit_hooks.d/"    || log_error "In copy_scripts: Failed to copy kernel-hook.sh"
    cp ../firmware-hook.sh "$dir/etc/apk/commit_hooks.d/"  || log_error "In copy_scripts: Failed to copy firmware-hook.sh"
