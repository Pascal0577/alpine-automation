...
configure_services() {
    ...
    rc-update add udev-settle sysinit    || log_error "In configure_services: Failed to add critical service"
    rc-update add udev-postmount default || log_error "In configure_services: Failed to add critical service"
